...
def fire_propagation(scenarios, fuel_map=fuel_map, wind_direction=wind_direction, critical_distance=critical_distance,
                     ignition_probability_map=ignition_probability_map):
