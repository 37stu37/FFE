...
# ignition_proba = ignition_proba[0:500, 0:500]
...
zeros = np.zeros((ignition_proba.shape[0], ignition_proba.shape[1], time_total - 1))
...
img = Image.fromarray(colored[0])
imshow(img)
# img = img.convert('RGB')
# img.save('/content/drive/My Drive/04_Cloud/01_Work/GNS/008_FFE/Colab_folder/img2.png')
# imshow(img)
# plt.show()
